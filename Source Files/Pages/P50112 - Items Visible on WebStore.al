page 50112 "Items Visible on WebStore"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Parent Category"; recItemCategoryCode."Parent Category")
                {
                    ApplicationArea = Basic, Suite;

                }
                field("Item Category Description"; recItemCategoryCode.Description)
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Has Children"; recItemCategoryCode."Has Children")
                {
                    ApplicationArea = Basic, Suite;
                }
    ...
    begin
        ...
        if IsNonInventoriable then
            Inventory := 0;
        //CV_SS>>
        if recItemCategoryCode.Get("Item Category Code") then;
        //SV_SS<<
    end;
    ...
    begin
        ...
        //CV_SS>>
        SetRange("Visible on WebStore", true);
        if recItemCategoryCode.Get("Item Category Code") then;
        //SV_SS<<
    end;
