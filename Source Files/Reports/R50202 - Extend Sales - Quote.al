report 50202 "Extend Sales - Quote"
{
    RDLCLayout = './Standard Sales - Quote Extn.rdlc';
    WordLayout = './Standard Sales - Quote Extn.docx';
    Caption = 'Sales - Quote';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(External_Reference_No; "External Document No.")
            {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    //CompanyInfo.Picture := TempBlobCompanyLogo.Blob;//CBR_SS
            ...
            begin
                ...
                SetLanguage("Language Code"); //CBR_SS
    ...
    begin
        ...
        // TempBlobCompanyLogo.Blob := CompanyInfo.Picture; //CBR_SS
        //TempBlobCompanyLogo.Insert; //CBR_SS
    end;
