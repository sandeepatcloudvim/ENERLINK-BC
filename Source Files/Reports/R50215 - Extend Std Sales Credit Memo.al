report 50215 "Extend Std Sales Credit Memo"
{
    RDLCLayout = './ExtendStdSalesCreditMemo.rdlc';
    WordLayout = './ExtendStdSalesCreditMemo.docx';
        ...
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            begin
                ...
                if ("Applies-to Doc. Type" = "Applies-to Doc. Type"::Invoice) then begin
                    if recSalesInv.Get(Header."Applies-to Doc. No.") then
                        if recSalesInv.FindFirst then begin
                            Clear(ShippingAgentName);
                            if ShippingAgent.Get(recSalesInv."Shipping Agent Code") then
